...
def parse_config():
    ...
    # MODEL CONTROLLER
    # parser.add_argument("--model", default='pretrained_models/model_controller/model_controller_best_0_2023-06-25_12-22-25')#model_controller/hotel_ctr
    parser.add_argument("--model", default='pretrained_models/model_controller/zara2_ctr')#model_controller/hotel_ctr
